...
ifeq ($(CONFIG_MACH_LGE),n)
	...
	dtb-$(CONFIG_MACH_MSM8226_E7WIFI) += msm8226-v1-e7wifi.dtb
	dtb-$(CONFIG_MACH_MSM8226_E7WIFI) += msm8226-v2-e7wifi.dtb
	dtb-$(CONFIG_MACH_MSM8226_E7LTE_ATT_US) += msm8226-e7lte.dtb
	dtb-$(CONFIG_MACH_MSM8226_E7LTE_VZW_US) += msm8226-e7lte.dtb
endif
